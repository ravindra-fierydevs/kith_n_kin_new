                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="pages/UI/general.html"><i class="fa fa-angle-double-right"></i>Add Employee</a></li>
                                <li><a href="pages/UI/icons.html"><i class="fa fa-angle-double-right"></i> Manage Employees</a></li>
                            </ul>
                        </li>
                    </ul>
                </section>
...
<footer class="footer">
    <div class="container">
        <p class="pull-left">&copy; Kith N Kin <?= date('Y') ?></p>
